...
//funcion para cargar Pacientes desde el gestor de archivo
function cargarPaciente(arrPacientes, arrCliente, elemento) {
    var datos = elemento.split(',');
    var nombre = datos[0];
    var especie = datos[1];
    var idDeCliente = readlineSync.questionInt("Ingrese id del Cliente: ");
    if (existeId(arrCliente, idDeCliente) == true) {
